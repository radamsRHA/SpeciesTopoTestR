#' Simulate.GeneTrees_From_SpeciesTree: function to simulate a set of gene trees given a species tree using HYBRID-LAMBDA under the MSC
#'
...
#######################################
# Simulate.GeneTrees_From_SpeciesTree #
#######################################
Simulate.GeneTrees_From_SpeciesTree <- function(handle.SpeciesTree, numeric.NumberOfGeneTrees, string.PathDir){
