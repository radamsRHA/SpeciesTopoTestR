#' Simulate.GeneTrees_From_SpeciesNetwork_MS: function to simulate a set of gene trees given a species network using PhyloNet under the MSC
#'
...
#' #####################################################
#' handle.SimulatedGeneTrees <- Simulate.GeneTrees_From_SpeciesNetwork_MS(string.SpeciesNetwork = string.SpeciesNetwork,
#'                                                                     string.PathDir = '~/Desktop/',
#'                                                                     numeric.NumberOfGeneTrees = 10)

##########################################
# Simulate.GeneTrees_From_SpeciesNetwork_MS #
##########################################
Simulate.GeneTrees_From_SpeciesNetwork_MS <- function(string.SpeciesNetwork, numeric.NumberOfGeneTrees, string.PathDir){
  ...
  string.NumberGeneTreesCmd <- gsub(pattern = "XXX", replacement = numeric.NumberOfGeneTrees, x = 'simGTinNetwork net XXX -ms "/Applications/msdir/ms";')
